 configObj = {
 	...
 	"shadowSize": "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
 	"roundnessSize": "16px",
 	"buttonDToBottom": "32px",
 	"buttonDToRight": "32px",
 	"selectedBackgroundColor": "#fcfcfc",
 ...
 document.getElementById("softr-back-to-top-button").style.transition = "all 2s";
